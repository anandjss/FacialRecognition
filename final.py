...
path = r'C:/Users/24jayashankar/Library/CloudStorage/OneDrive-DurhamAcademy/Desktop/FacialRecognition/Images *.*'
...
def create_or_open_workbook():  # makes excell file??
...
def is_username_unique(sheet, username):  # new user??
...
def is_late_or_ontime(current_time_str, target_time_str, lateness_threshold_minutes):  # are we here on time?
    try:
...
def main(user_input):  # face recognition and making the spreadsheet
    ...
    if is_username_unique(sheet, user_input):
        ...
        target_time_str = '10:00'  # this is 'on time'
        lateness_threshold_minutes = 6  # window to show up
