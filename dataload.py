...
def snapshot():  # adds the images to the folder
    ...
    for face_location in face_locations:
        ...
        name = name_var.get()
        im1.save(r'C:/Users/24jayashankar/Library/CloudStorage/OneDrive-DurhamAcademy/Desktop/FacialRecognition/Images''+name+.jpg')


def updatedata():  # adds users
